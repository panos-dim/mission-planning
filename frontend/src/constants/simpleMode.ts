...
export const isDebugExplorerEnabled = () =>
  getUrlParams().get("debug") === "explorer";
export const isDebugModeFromUrl = () => getUrlParams().has("debug");
export const isAdvancedPlanningEnabled = () =>
  getUrlParams().get("debug") === "planning" ||
  getUrlParams().get("debug") === "all";
...
export const LEFT_SIDEBAR_PANELS = {
  ...
  PLANNING: "planning",
  SCHEDULE: "schedule", // Combined Orders + Conflicts
