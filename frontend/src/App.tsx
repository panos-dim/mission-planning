...
function AppContent(): JSX.Element {
  ...
  // Keyboard handler for Esc key to exit add mode
  useEffect(() => {
          ...
          <div className="px-6 h-full flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-lg font-semibold text-white">
                <span className="text-white font-bold">COSMOS</span><span className="text-blue-400 font-bold">42</span>
                <span className="text-gray-400 font-normal text-sm ml-2">Complete Orbital Mission Scheduling & Optimization System</span>
              </h1>
            </div>
            
            <div className="flex items-center space-x-4">
              <ViewModeToggle />
              <div className="flex items-center space-x-2 px-3 py-1.5 bg-gray-800 rounded-lg border border-gray-700" title="System Time (UTC)">
