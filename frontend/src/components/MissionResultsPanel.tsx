  ...
  const sortedPasses = [...state.missionData.passes]
    .filter((pass) => {
      ...
      if (isSARMission && pass.sar_data) {
        if (lookSideFilter !== 'ALL' && pass.sar_data.look_side !== lookSideFilter) {
          return false
        }
                    ...
                    <>
                      {state.missionData.imaging_type === 'sar' && state.missionData.sar ? (
                        <>
                          ...
                          <div className="flex justify-between">
                            <span className="text-gray-400">SAR Opportunities:</span>
                  ...
                  {state.missionData.targets.map((target, index) => {
                    ...
                    return (
                      <div key={index} className="flex items-center space-x-2 text-xs">
                        ...
                        />
                        <span className={hasOpportunities ? 'text-white' : 'text-gray-500'}>
                          {target.name}
                        </span>
                        {hasOpportunities ? (
                          ...
                          <span className="text-red-400 text-[10px]">(no opportunities)</span>
                        )}
          ...
          {expandedSections.includes('schedule') && (
            <div className="p-3 bg-gray-850 space-y-2 max-h-96 overflow-y-auto">
              ...
              {sortedPasses.map((pass, index) => {
                const opportunityColor = getOpportunityColor(pass, index, satellites)
                ...
                return (
                  <div
                    ...
                    className={`glass-panel rounded-lg p-2 cursor-pointer transition-colors ${
                      isSelected ? 'bg-blue-900/50 ring-1 ring-blue-500' : 'hover:bg-gray-800/50'
                    }`}
                    onClick={() => {
                    ...
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-xs font-medium text-white">
                          {pass.sar_data ? 'SAR' : 'Imaging'} Opportunity {index + 1}
                        </span>
                        {/* SAR badges */}
                        {pass.sar_data && (
                      ...
                      {state.missionData?.mission_type !== 'imaging' && !pass.sar_data && (
                    ...
                    <div className="text-xs space-y-0.5">
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-300">
                          ...
                          {pass.start_time.substring(0, 4)} [{pass.start_time.substring(11, 19)} -{' '}
                      ...
                      {pass.sar_data ? (
                        ...
                        <div className="flex justify-between">
                          <span className="text-gray-500">Min Incidence Angle:</span>
                          <span className="text-gray-300">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-4">
                      {state.missionData.targets.map((target, targetIdx) => {
                        ...
                        const timeRange = lastOpportunityMs - firstOpportunityMs
                        const paddedStart = firstOpportunityMs - (timeRange * 0.05 || 60000)
                        const paddedEnd = lastOpportunityMs + (timeRange * 0.05 || 60000)
                          ...
                          <div key={targetIdx} className="space-y-2">
                            ...
                            <div className="relative h-8 pt-5">
                              ...
                              {clusters.map((cluster, clusterIdx) => {
                                const clusterCenter =
                                  cluster.reduce((sum, m) => sum + m.position, 0) / cluster.length
                                ...
                                if (cluster.length === 1) {
                                  ...
                                  const position = Math.max(2, Math.min(98, cluster[0].position))
                                  ...
                                  return (
                                    ...
                                    >
                                      <div
                                        ...
                                        title={`Opportunity ${globalIndex + 1}: ${
                                          pass.target
                                  ...
                                  const position = Math.max(3, Math.min(97, clusterCenter))
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div
                                        ...
                                        style={{
                                          marginLeft: `-${(cluster.length - 1) * 4}px`,
                                        }}
                                      >
                                        {cluster
                                          .slice()
                                          ...
                                          .map((marker, mIdx) => {
                                            ...
                                            return (
                                              <div
                                                ...
                                                title={`Opportunity ${marker.globalIndex + 1}: ${
                                                  marker.pass.target
                    ...
                    <div className="mt-6 space-y-2">
                      {sortedPasses.map((pass, index) => {
                        const passDate = new Date(pass.start_time.replace('+00:00', 'Z'))
                        const passColor = getOpportunityColor(pass, index, satellites)
                        return (
                          <div key={index} className="flex items-center gap-2 text-[11px]">
                            ...
                            ></div>
                            <span className="font-semibold" style={{ color: passColor }}>
                              Opportunity {index + 1}:
                            </span>
                            <span className="text-gray-300">
            ...
            <div className="p-3 bg-gray-850">
              ...
              {state.missionData.mission_type === 'imaging' ? (
                <div className="mt-3 glass-panel rounded-lg p-3">
                  <h4 className="text-xs font-semibold text-white mb-2">Imaging Statistics</h4>
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between">
                      <span className="text-gray-400">Total Opportunities:</span>
                      <span className="text-white">{state.missionData.passes.length}</span>
                    </div>
                ...
                state.missionData.pass_statistics && (
                  <div className="mt-3 glass-panel rounded-lg p-3">
                    <h4 className="text-xs font-semibold text-white mb-2">Opportunity Types</h4>
                    <div className="space-y-1 text-xs">
