      ...
      <div className="p-4 border-b border-gray-700">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold text-white">
            {state.missionData ? "Mission Results" : "Mission Controls"}
          </h2>
          {state.missionData && (
          ...
          <div className="h-full flex items-center justify-center p-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">
                Configure your mission parameters and analyze to see results
                here.
              </p>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="text-xs space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white">
                        {pass.start_time.substring(5, 10)}{" "}
                        {pass.start_time.substring(11, 16)} UTC
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">End:</span>
                      <span className="text-white">
                        {pass.end_time.substring(5, 10)}{" "}
                        {pass.end_time.substring(11, 16)} UTC
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-400">
                          {pass.start_time.substring(11, 16)} →{" "}
                          {pass.end_time.substring(11, 16)} UTC
                        </div>
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-yellow-400">
                    {(() => {
                      const totalSeconds = state.missionData.passes.reduce(
                        (sum, pass) => {
                ...
                <div>
                  <div className="text-2xl font-bold text-blue-400">
                    {Math.max(
                      ...state.missionData.passes.map((p) => p.max_elevation)
                    ).toFixed(1)}
                    °
                  </div>
                ...
                {state.missionData.targets.map((target) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-white">
                        {targetPasses.length} opportunities
                      </span>
                    </div>
                  );
                })}
