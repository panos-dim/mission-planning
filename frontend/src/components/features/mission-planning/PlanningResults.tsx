            ...
            <table className="w-full text-xs">
              ...
              <tbody className="text-gray-300">
                <tr className="border-b border-gray-600 bg-blue-900/20">
                  ...
                  {availableAlgorithms.map((alg) => (
                    <td key={alg} className="text-right py-1 px-2 font-bold">
                      {results[alg].target_statistics?.targets_acquired ??
                        "N/A"}{" "}
                ...
                <tr className="border-b border-gray-600">
                  ...
                  {availableAlgorithms.map((alg) => (
                    <td key={alg} className="text-right py-1 px-2">
                      {results[alg]?.metrics?.mean_incidence_deg?.toFixed(2) ??
                        "N/A"}
                    </td>
                  ))}
                </tr>
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={() => onExportJson(activeTab)}
                >
                  Export JSON
                </Button>
              </div>
